...
class KittiDataset(Dataset):
    def __init__(self, dataset_dir, mode='train', lidar_transforms=None, aug_transforms=None, multiscale=False,
                 num_samples=None, mosaic=False, random_padding=False, rect=False):
        self.rect = rect
        ...
        self.labels = 2 # For testing if labels parameter is working.
        ...
        # print(f"THis is image id list, {self.image_idx_list}")
        if self.is_test:
        ...
        self.labels = [self.get_label(sample_id) for sample_id in self.sample_id_list]
